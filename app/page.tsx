...
export default function HomePage() {
  return (
    <>
      ...
      <section className="py-28 lg:py-36" style={{ backgroundColor: "#2a2a2a" }} aria-labelledby="services-heading">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
      ...
      <section className="py-28 lg:py-36" style={{ backgroundColor: "#000000" }} aria-labelledby="value-prop-heading">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
