...
export const metadata: Metadata = {
  title: "Domotique pour Villas & Appartements — Systèmes Intelligents Maroc | Domotus",
  description:
    "Domotique multi-protocoles (KNX, Crestron, Lutron) pour villas et appartements de prestige au Maroc. Éclairage, sécurité, énergie. Casablanca, Marrakech, Rabat.",
