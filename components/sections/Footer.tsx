...
const NAV_COLS = [
  {
    ...
    links: [
      { href: "/maison-connectee#modes-de-vie", label: "Scénarios" },
      ...
      { href: "/maison-connectee#portfolio", label: "Portfolio & Inspirations" },
    ],
  },
  {
    ...
    links: [
      ...
      { href: "/contact?type=support", label: "Support" },
    ],
  },
  {
    title: "Protocoles",
    links: [
      { href: "/technologies/knx", label: "KNX — Standard international d'intégration" },
      { href: "/technologies/crestron", label: "Crestron — Solutions hautes performances" },
      { href: "/technologies/lutron", label: "Lutron — Contrôle d'éclairage avancé" },
      { href: "/technologies/matter", label: "Matter — Compatibilité universelle" },
      { href: "/technologies/zigbee", label: "Zigbee — Réseau sans fil robuste" },
      { href: "/technologies/zwave", label: "Z-Wave — Fiabilité longue portée" },
      { href: "/technologies/wifi7", label: "Wi-Fi 7 — Connectivité ultra-rapide" },
    ],
  },
  {
    title: "Domotus",
    links: [
      { href: "/expertises#vision", label: "Vision" },
      { href: "/blog", label: "Blog Domotique" },
      { href: "/mentions-legales", label: "Mentions légales" },
      { href: "/politique-confidentialite", label: "Politique de confidentialité" },
      { href: "/contact?type=devis", label: "Demander Audit & Devis", highlight: true },
    ],
  },
];
