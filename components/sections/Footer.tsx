...
const NAV_COLS = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/hospitalite", label: "Hospitalité" },
      { href: "/retail", label: "Retail" },
      { href: "/bureaux", label: "Bureaux & Tertiaire" },
      { href: "/projets-speciaux", label: "Projets Spéciaux" },
    ],
  },
  {
    title: "Protocoles",
    links: [
      { href: "/technologies/knx", label: "KNX" },
      { href: "/technologies/crestron", label: "Crestron" },
      { href: "/technologies/lutron", label: "Lutron" },
      { href: "/technologies/matter", label: "Matter" },
      { href: "/technologies/zigbee", label: "Zigbee" },
      { href: "/technologies/zwave", label: "Z-Wave" },
      { href: "/technologies/wifi7", label: "Wi-Fi 7" },
    ],
  },
  {
    title: "Domotus",
